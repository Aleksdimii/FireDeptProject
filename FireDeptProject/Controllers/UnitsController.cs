...
namespace FireDeptProject.Controllers
{
    public class UnitsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,FirstName,LastName")] Unit unit)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FirstName,LastName")] Unit unit)
        {
            if (id != unit.Id)
            {
                return NotFound();
